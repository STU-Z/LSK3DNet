        ...
        for i_iter, (train_data_dict) in enumerate(train_dataset_loader):
                ...
                if train_hypers.local_rank == 0:
                    ...
                    if best_val_miou < val_miou:
                        ...
                        try:  # with nn.DataParallel() the net is added as a submodule of DataParallel
                            if sparse_config['use_sparse']:
                                save_dict = {
                                    'checkpoint':my_model.module.state_dict() if hasattr(my_model, "module") else my_model.state_dict(), 'mask': mask.masks}
                            else:
                                save_dict = {
            ...
            if train_hypers.local_rank == 0:
                ...
                if global_iter % check_iter == 0 and global_iter != 0:
                    ...
                    print(f"[DEBUG] Epoch {epoch}, Iter {i_iter}: Train mIoU: {train_miou:.2f}")
