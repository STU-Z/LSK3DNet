...
def main_worker(local_rank, nprocs, configs):
    ...
    #         print(f"[ERROR] Exception in train_dataset_loader at epoch {epoch}, iter {i_iter}: {e}")
    #         import traceback
    #         traceback.print_exc()
    #         raise
    #     epoch += 1
    ...
    while epoch < train_hypers['max_num_epochs']:
        ...
        for i_iter, (train_data_dict) in enumerate(train_dataset_loader):
            ...
            #                     save_dict = {
            #                         'epoch': epoch,
            #                                 'checkpoint':my_model.module.state_dict() if hasattr(my_model, "module") else my_model.state_dict(),
            ...
            print(f"train_data_dict keys: {train_data_dict.keys()}", flush=True)
            ...
            print(f"train_data_dict['points'].shape: {train_data_dict['points'].shape}", flush=True)
